    ...
    <div className="min-h-screen bg-zinc-50 font-sans">
      <header className="bg-white border-b border-zinc-200">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-zinc-900">💪 Workouts</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg border border-zinc-200 p-6 mb-8">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h2 className="text-xl font-semibold text-zinc-900">Synchronisation Hevy</h2>
            ...
            <button
              onClick={syncHevy}
              disabled={syncing}
              className="px-6 py-3 bg-zinc-900 text-white rounded-lg hover:bg-zinc-800 transition font-medium disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="bg-white rounded-lg border border-zinc-200 p-6">
          ...
          {workouts.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-zinc-500 mb-4">Aucune séance enregistrée</p>
              <button
                onClick={syncHevy}
            ...
            <div className="space-y-4">
              {workouts.map((workout) => (
                <div key={workout.id} className="p-4 bg-zinc-50 rounded-lg border border-zinc-200">
